...
//import com.leon.verify.VerifyApk;
//
//import java.io.File;
...
//    }
//
//    public static void verifyApk(String apkPath, String signerPath) throws IOException, InterruptedException {
//        ArrayList<String> command = new ArrayList<>();
//        command.add("java");
//        command.add("-jar");
//        command.add(signerPath);
//        command.add("verify");
//        command.add("-v");
//        command.add(apkPath);
